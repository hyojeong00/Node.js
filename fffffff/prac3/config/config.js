...
module.exports = {
	...
	route_info:[
			{file:'../src/routes/login', path:'/login', method:'login', type:'get'},
			...
			//라인
			{file:'../src/routes/line', path:'/line1', method:'line1', type:'get'},
			
			{file:'../src/routes/line', path:'/line2', method:'line2', type:'get'},
	...
	mapper_info:[
		...
		{mapperNm : 'lineMapper' , path: './src/mapper/lineMapper.xml'},
